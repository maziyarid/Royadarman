...
<main class="shell">
    <header class="top">
        ...
        <div class="actions">
            ...
            <form method="post" action="/api/v1/auth/logout">@csrf<button class="btn" type="submit">{{ __('panel.logout') }}</button></form>
        </div>
    </header>
