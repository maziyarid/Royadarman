...
<div class="card">
    ...
    @else
    <table><thead><tr><th scope="col">{{ __('ui.dashboard.col_id') }}</th><th scope="col">{{ __('ui.dashboard.col_action') }}</th><th scope="col">{{ __('ui.dashboard.col_actor') }}</th><th scope="col">{{ __('ui.dashboard.col_updated') }}</th></tr></thead>
