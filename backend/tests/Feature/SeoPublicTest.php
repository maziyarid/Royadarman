...
final class SeoPublicTest extends TestCase
{
    ...
    public function test_locale_sitemap_includes_home_and_published_posts_only(): void
    {
        ...
        $response->assertSee(url('/'), false)
            ->assertSee(url('/blog/implant-guide'), false)
    ...
    public function test_blog_show_renders_published_post_with_canonical_and_hreflang(): void
    {
        ...
        $response = $this->get('/blog/implant-guide')
            ->assertOk()
            ->assertSee('<html lang="fa" dir="rtl">', false)
            ->assertSee('<link rel="canonical" href="'.url('/blog/implant-guide').'">', false)
            ->assertSee('<link rel="alternate" hreflang="fa" href="'.url('/blog/implant-guide').'">', false)
    ...
    public function test_blog_show_returns_404_for_draft_post(): void
    {
        ...
        $this->get('/blog/not-published')->assertNotFound();
    }
    ...
    public function test_redirect_manager_issues_301_for_known_source_path(): void
    {
        ...
        $this->get('/old-page')->assertRedirect('/')->assertStatus(301);
    ...
    public function test_redirect_manager_issues_302_when_configured(): void
    {
        ...
        $this->get('/temp-page')->assertRedirect('/services')->assertStatus(302);
    }
    ...
    public function test_published_service_page_renders_with_service_schema(): void
    {
        ...
        $post->translations()->create(['locale' => 'fa', 'title' => 'مشاوره ایمپلنت', 'slug' => 'implant-consultation', 'body' => '<p>توضیحات</p>', 'sanitized_body' => '<p>توضیحات</p>']);

        $this->get('/services/implant-consultation')
            ->assertOk()
            ->assertSee('مشاوره ایمپلنت', false)
    ...
    public function test_blog_post_is_not_accessible_via_page_route(): void
    {
        ...
        $this->get('/blog-post-via-page')->assertNotFound();
    }
