...
need "checks/mariadb-isolated.md"
need "checks/mariadb-isolated.sh"
...
contains "checks/ci-empty-step.md" "account is locked due to a billing issue"
contains "checks/ci-empty-step.md" "Do not rewrite"
contains "checks/ci-empty-step.md" "runner_id"
contains "checks/ci-empty-step.md" "Billing & Licensing"
...
contains "checks/mariadb-isolated.md" "Committing this file does not start MariaDB"
contains "checks/mariadb-isolated.md" "Never against the live host"
contains "checks/mariadb-isolated.md" "phpunit.mariadb.xml"
contains "checks/mariadb-isolated.md" "DROP DATABASE"
contains "checks/mariadb-isolated.md" "mariadb-isolated.sh"
contains "checks/mariadb-isolated.md" "127.0.0.1"
contains "checks/mariadb-isolated.md" "royadarman_iso_test"
contains "checks/mariadb-isolated.md" "never a bare"
contains "checks/mariadb-isolated.md" "bootstrap/cache/config.php"
contains "checks/mariadb-isolated.sh" "Committing this file does not start MariaDB"
contains "checks/mariadb-isolated.sh" "127.0.0.1"
contains "checks/mariadb-isolated.sh" "3307"
contains "checks/mariadb-isolated.sh" "royadarman_iso_test"
contains "checks/mariadb-isolated.sh" "refusing"
contains "checks/mariadb-isolated.sh" "migrate:fresh --force"
contains "checks/mariadb-isolated.sh" "phpunit.mariadb.xml"
contains "checks/mariadb-isolated.sh" "bootstrap/cache/config.php"
